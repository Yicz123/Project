...
public class UserService {
    ...
    public static String getallinfo(String ur, String coursename) {
        try {
            String data = "courseName=" + coursename;
            String path = ur + data;
            Log.i("aaa", path);
            StringBuffer sb = new StringBuffer(path);
            URL url = new URL(sb.toString());
    ...
    public static String getfeature(String ur, String Sid) {
        try {
            String data = "Sid=" + Sid;
            String path = ur + data;
            Log.i("aaa", path);
    ...
    //获取人脸识别返回的结果
    public static String loginOfGet1(String ur, String coursename, String picPath) {
        //Log.i("aaa",picPath);
        ...
        try {
            String data = "userName=" + coursename;
            String path = ur + data;
            Log.i("aaa", path);
    ...
    public static String Submit(String ur, String coursename, String totalnum, String realnum, String notcome) {
        try {
            String data = "coursename=" + coursename + "&totalnum=" + totalnum + "&realnum=" + realnum + "&notcome=" + notcome;
            String path = ur + data;
            Log.i("aaa", path);
            StringBuffer sb = new StringBuffer(path);
            URL url = new URL(sb.toString());
    ...
    public static String Record(String ur, String coursename) {
        try {
            String data = "coursename=" + coursename;
            String path = ur + data;
            Log.i("aaa", path);
    ...
    public static String getallrecord(String ur, String coursename) {
        try {
            String data = "coursename=" + coursename;
            String path = ur + data;
            Log.i("aaa", path);
